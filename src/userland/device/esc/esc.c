/*
    This source file is generated by sotom at 2023-05-14 11:37:54.385773
...
void ESC_write(ESC* esc, uint16_t micros) {
    ...
    //detect code and set duty in micro seconds
    if (esc->channel == CHANNEL1) {
        TIM2->CCR1 = micros;
    }
    if (esc->channel == CHANNEL2) {
        TIM2->CCR2 = micros;
    }
    if (esc->channel == CHANNEL3) {
        TIM2->CCR3 = micros;
    }
    if (esc->channel == CHANNEL4) {
        TIM2->CCR4 = micros;
    }
}
